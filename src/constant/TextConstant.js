...
export const WHICH_PLAN = {
  ...
  content: `While 401(k) and Roth IRA are both popular tax-advantaged retirement savings account, they differ in how they are taxed. Both plans, however, will allow your savings to grow tax-free, unlike other investment options. You will be eligible to take money out of your accounts after the age of 59 ½. For HSA, you can take money out of your account after the age of 65.`,
  subcontent: [
    {
      title: `401(k)`,
      content: `Contributions to 401(k) are pre-tax, meaning they are deposited into your account before income tax deduction. However, once you're in retirement, your withdrawals are taxed at your then-current income tax rate, meaning you'll be taxed at the income rate of how much you withdraw. 401(k) is good for someone who expects to have a higher income than how much they'll be withdrawing in retirement. The contribution limit for 401(k) as of 2021 is $19,500 per year and there is no income limit.`,
    },
    {
      title: `Roth IRA`,
      content: `Contributions to Roth IRA are post-tax, meaning they are deposited into your acccount after income tax deduction. However, once you're in retirement, your withdrawals are not taxed. Roth IRA is good for someone who expects to take out more money in retirement than how much they've earned during their career. The contribution limit for Roth IRA as of 2021 is $6,500 per year and there is an income limit of $139,000, meaning if you make over the limit, you cannot contribute.`
    },
    {
      title: `Health Savings Account (HSA)`,
      content: `If your company offers an HSA, you have the ability to contribute your balance into an investment account, instead of letting the money sit and depreciate with inflation. An HSA is typically considered a triple tax-advantaged account as you can contribute to your HSA tax-free, your savings will grow tax-free, and you can use your HSA for qualified medical expenses tax-free. It is estimated that a newly retired 65 year old couple will need ~$300,000 for medical expenses in retirement. You can also take money out of your HSA after the age of 65, but it'll be subject to regular income tax. The contribution limit for HSA as of 2021 is $3,550 per year and there is no income limit. Keep in mind, if you want to invest into an HSA account, you'll need to have the high-deductible insurance plan offered by your employer.`
    }
  ]
};